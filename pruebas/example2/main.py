...
from utils.models.LSTM.model_1 import build_model, build_model_2, build_model_3
from utils.save import save_model_and_scalers, load_model_and_scalers

load_dotenv()

# Configuración
LOOKBACK = 20  # Número de pasos anteriores a considerar para la predicción
...
def train_and_evaluate(data):
    ...
    if (NEW_MODEL):
        ...
        # Construir modelo
        model = build_model_3((LOOKBACK, len(input_features)),
